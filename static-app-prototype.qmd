...
I'd like to compare with ages and other numerical fields, but they are too granular. I need to create some groups.
...
data$`App Usage Time (hr/day)` <- round(data$`App Usage Time (min/day)`/60,digits=1)
